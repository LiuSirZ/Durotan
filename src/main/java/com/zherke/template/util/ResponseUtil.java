package com.zherke.template.util;

import com.zherke.template.constant.CommonTipConstant;
import com.zherke.template.bean.BaseResponseVo;
import com.zherke.template.bean.CommonResultCode;
...
public class ResponseUtil {
    ...
    /**
     * 返回成功
     * code:{@link com.zherke.template.bean.CommonResultCode#SUCCESS}
     * msg:{@link com.zherke.template.bean.CommonResultCode#SUCCESS}
     *
     * @param data 响应数据
     * @return BaseResponseVo
     */
    ...
    /**
     * 返回系统错误
     * code:{@link com.zherke.template.bean.CommonResultCode#SYSTEM_INSIDE_ERROR}
     * msg:{@link com.zherke.template.bean.CommonResultCode#SYSTEM_INSIDE_ERROR}
     *
     * @param data 响应数据
     * @return BaseResponseVo
     */
