...
import com.zherke.durotan.constant.CommonTipConstant;
...
public class ResponseUtil {
    ...
    /**
     * 返回成功
     * code:{@link com.zherke.durotan.bean.CommonResultCode#SUCCESS}
     * msg:{@link com.zherke.durotan.bean.CommonResultCode#SUCCESS}
     *
     * @param data 响应数据
     * @return BaseResponseVo
     */
    ...
    /**
     * 返回失败
     * code:{@link com.zherke.durotan.bean.CommonResultCode#FAIL}
     * msg:{@link com.zherke.durotan.bean.CommonResultCode#FAIL}
     *
     * @param msg 失败信息(必填)
     * @return
     */
    ...
    /**
     * 返回系统错误
     * code:{@link com.zherke.durotan.bean.CommonResultCode#SYSTEM_INSIDE_ERROR}
     * msg:{@link com.zherke.durotan.bean.CommonResultCode#SYSTEM_INSIDE_ERROR}
     *
     * @param data 响应数据
     * @return BaseResponseVo
     */
    ...
    /**
     * 返回系统异常
     * code:{@link com.zherke.durotan.bean.CommonResultCode#UNKNOWN_ERROR}
     * msg:{@link com.zherke.durotan.bean.CommonResultCode#UNKNOWN_ERROR}
     *
     * @param data 响应数据
     * @return BaseResponseVo
     */
